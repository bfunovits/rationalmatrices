...
#include "../inst/include/rationalmatrices_lyapunov.h"
...
bool lyapunov_cpp(const arma::mat& A, const arma::mat& Q, arma::mat& P,
  ...
  return rationalmatrices::lyapunov_impl(A, Q, P, lambda_r, lambda_i, stop_if_non_stable);
}
...
bool lyapunov_Jacobian_cpp(const arma::mat& A, const arma::mat& Q, arma::mat& P,
  ...
  int i;
  for (i = (m-1); i>0; i--) {
    rationalmatrices::solve_lyapunov_core_loop(i, cQ, cS, cA);
  }
  // For i=0, only the diagonal element update is needed
