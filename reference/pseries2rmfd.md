...
#> left factor d(z):
#>       z^0 [,1]      [,2]  z^1 [,1]       [,2]
#> [1,] -5.091755 -1.438857  6.456551  2.6585646
#> [2,] -7.267005 -2.437339 -2.535447 -0.1576134
#> [3,] -7.071941 -1.612433  3.931768  0.5752943
#> right factor c(z):
#>      z^0 [,1]  [,2]  z^1 [,1]        [,2]
#> [1,]        1     0 -4.503827 -1.55196163
#> [2,]        0     1 -3.063279  0.01781338
#> 
#> $mu
#> [1] 1 1
#> 
