...
#> left factor a(z):
#>      z^0 [,1]  [,2]  [,3]    z^1 [,1]       [,2]       [,3]
#> [1,]        1     0     0 -0.09689396  0.1288137  0.2504258
#> [2,]        0     1     0 -0.28856566  0.2908807 -0.2004376
#> [3,]        0     0     1 -0.20170738 -0.4079080 -0.2134212
#> right factor b(z):
#>       z^0 [,1]       [,2]  z^1 [,1]       [,2]
#> [1,] 0.1612558 -1.2614246 -3.940664 -1.8820022
#> [2,] 1.8591409 -2.1324443 -4.289259 -2.4525251
#> [3,] 1.3089943  0.2891434 -1.245475 -0.2485643
#> 
#> $nu
#> [1] 1 1 1
#> 
