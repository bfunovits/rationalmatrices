...
#> left factor a(z):
#>      z^0 [,1]  [,2]  [,3]   z^1 [,1]       [,2]       [,3]
#> [1,]        1     0     0 -0.3677274 -0.7104738 -1.1927351
#> [2,]        0     1     0  0.8238783  1.3105739  1.3572873
#> [3,]        0     0     1  0.4685666  0.2574831  0.4111164
#> right factor b(z):
#>        z^0 [,1]      [,2]   z^1 [,1]       [,2]
#> [1,] -0.3959487  1.816864 -2.6111037 -2.1012341
#> [2,] -1.9899201 -1.711841 -0.3323790 -1.3122728
#> [3,]  0.7543677 -1.095713 -0.6467567 -0.8929859
#> 
#> $nu
#> [1] 1 1 1
#> 
