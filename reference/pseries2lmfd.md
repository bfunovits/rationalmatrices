...
#> left factor a(z):
#>      z^0 [,1]  [,2]  [,3]    z^1 [,1]       [,2]        [,3]
#> [1,]        1     0     0 -0.05049533 -0.5074285  0.05784943
#> [2,]        0     1     0 -0.28029358  0.4212372  0.04101660
#> [3,]        0     0     1  0.14190910 -1.3877377 -0.07752848
#> right factor b(z):
#>       z^0 [,1]       [,2]   z^1 [,1]      [,2]
#> [1,]  2.209208 -1.0776371 -0.1191935 -1.674088
#> [2,] -0.193683 -1.5553816 -2.0081553 -1.168952
#> [3,]  1.636943  0.4598545  3.4794672 -1.096121
#> 
#> $nu
#> [1] 1 1 1
#> 
