...
#> left factor a(z):
#>      z^0 [,1]  [,2]    z^1 [,1]      [,2]
#> [1,]        1     0 -0.39804530 0.4637384
#> [2,]        0     1 -0.07210853 0.1610383
#> right factor b(z):
#>        z^0 [,1]       [,2]  z^1 [,1]       [,2]
#> [1,] -0.1475663 -0.3340930 0.2018156 -0.1739697
#> [2,] -0.5055669  0.5528613 0.3364497  0.5877558
zvalues(ll)
#> ( 2 x 2 ) frequency response
#>          z[1] [,1]          [,2]               z[2] [,1]                   [,2]
#> [1,]  0.1930977+0i -1.5277609+0i -0.001923237-0.3354881i -0.07647995+0.6891298i
#> [2,] -0.1336676+0i  0.8875267+0i -0.351543660-0.3630985i  0.80084473-0.3960261i
#>                  z[3] [,1]                   [,2]             z[4] [,1]
#> [1,] -0.4637148-0.2612472i -0.029692+0.001674846i -0.4637148+0.2612472i
#> [2,] -0.8454997-0.2792829i  0.132535-0.381466730i -0.8454997+0.2792829i
#>                        [,2]               z[5] [,1]                   [,2]
#> [1,] -0.029692-0.001674846i -0.001923237+0.3354881i -0.07647995-0.6891298i
#> [2,]  0.132535+0.381466730i -0.351543660+0.3630985i  0.80084473+0.3960261i
```
