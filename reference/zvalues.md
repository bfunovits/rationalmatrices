...
#> left factor a(z):
#>      z^0 [,1]  [,2]   z^1 [,1]       [,2]
#> [1,]        1     0 -0.4531647 0.79571435
#> [2,]        0     1 -0.7107248 0.06960816
#> right factor b(z):
#>       z^0 [,1]      [,2]  z^1 [,1]       [,2]
#> [1,] 1.3787791 0.4493462 0.1686561 -1.6175099
#> [2,] 0.4639216 0.9876719 0.1393580  0.1725857
zvalues(ll)
#> ( 2 x 2 ) frequency response
#>        z[1] [,1]          [,2]             z[2] [,1]                 [,2]
#> [1,] 1.021451+0i -1.8886022+0i 3.173212-0.008620166i 0.4188904+5.2987334i
#> [2,] 1.242745+0i -0.1701733+0i 1.311947-2.146309447i 4.5507823+0.9962937i
#>                  z[3] [,1]                     [,2]             z[4] [,1]
#> [1,]  0.7698452-0.4049250i  1.55783536+0.009660233i  0.7698452+0.4049250i
#> [2,] -0.2678399-0.1924894i -0.01142268-0.803505215i -0.2678399+0.1924894i
#>                          [,2]             z[5] [,1]                 [,2]
#> [1,]  1.55783536-0.009660233i 3.173212+0.008620166i 0.4188904-5.2987334i
#> [2,] -0.01142268+0.803505215i 1.311947+2.146309447i 4.5507823-0.9962937i
```
