...
#>      z^-1 [,1]  z^0 [,1]  z^1 [,1]
#> [1,] 0.5112128 -0.446467 0.4983735
inflate_object(lp, 2, 2)
#> ( 2 x 2 ) Laurent polynomial matrix with degree <= 1, and minimal degree >= -1
#>      z^-1 [,1]      [,2]  z^0 [,1]      [,2]  z^1 [,1]      [,2]
#> [1,] 0.5112128 0.5112128 -0.446467 -0.446467 0.4983735 0.4983735
#> [2,] 0.5112128 0.5112128 -0.446467 -0.446467 0.4983735 0.4983735

(ss = test_stsp(s = 1))
#> statespace realization [1,1] with s = 1 states
#>           s[1]      u[1]
#> s[1] 0.4448055 -1.157583
#> x[1] 0.1565042  1.000000
inflate_object(ss, 2, 2)
#> statespace realization [2,2] with s = 2 states
#>           s[1]      s[2]      u[1]      u[2]
#> s[1] 0.4448055 0.0000000 -1.157583 -1.157583
#> s[2] 0.0000000 0.4448055 -1.157583 -1.157583
#> x[1] 0.1565042 0.0000000  1.000000  1.000000
#> x[2] 0.0000000 0.1565042  1.000000  1.000000
```
