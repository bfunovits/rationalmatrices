...
#> left factor a(z):
#>      z^0 [,1]  [,2]  z^1 [,1]       [,2]
#> [1,]        1     0 0.8914854 -0.9645553
#> [2,]        0     1 0.4558664 -0.3299148
#> right factor b(z):
#>       z^0 [,1]        [,2]  z^1 [,1]       [,2]
#> [1,] 0.6297224 -0.07659314 0.2059331  0.8989942
#> [2,] 0.1705679 -0.27900729 0.3518605 -0.9530273
l[,1]
...
#> right factor b(z):
#>       z^0 [,1]  z^1 [,1]
#> [1,] 0.6297224 0.2059331
#> [2,] 0.1705679 0.3518605
...
#> left factor d(z):
#>        z^0 [,1]      [,2]   z^1 [,1]       [,2]
#> [1,] 0.05129262 0.9754168 -0.1049963  1.0707013
#> [2,] 1.57602957 0.7716906 -0.7689393 -0.1798724
#> right factor c(z):
#>      z^0 [,1]  [,2]   z^1 [,1]       [,2]
#> [1,]        1     0  0.6500508  1.3547573
#> [2,]        0     1 -0.6637762 -0.8674562
r[1,]
#> ( 1 x 2 ) right matrix fraction description d(z) c^(-1)(z) with degrees deg(c(z)) = p = 1, deg(d(z)) = q = 1
#> left factor d(z):
#>        z^0 [,1]      [,2]   z^1 [,1]     [,2]
#> [1,] 0.05129262 0.9754168 -0.1049963 1.070701
#> right factor c(z):
#>      z^0 [,1]  [,2]   z^1 [,1]       [,2]
#> [1,]        1     0  0.6500508  1.3547573
#> [2,]        0     1 -0.6637762 -0.8674562
