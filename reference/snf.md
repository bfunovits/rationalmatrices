...
#>                                   [,1]                     [,2]           [,3]
#> [1,]  -0.5z - 1.3z^2 + 0.5z^3 + 1.3z^4  -0.5z - 1.8z^2 - 1.3z^3    -z + 1.2z^2
#> [2,]        -z - 1.5z^2 + z^3 + 1.5z^4     -z - 2.5z^2 - 1.5z^3    -0.9z + z^2
#> [3,]  -0.4z - 0.6z^2 + 0.4z^3 + 0.6z^4     -0.4z - z^2 - 0.6z^3  0.1z - 0.4z^2 
