...
#>                                   [,1]                     [,2]            [,3]
#> [1,]  -0.6z - 1.4z^2 + 0.6z^3 + 1.4z^4    -0.6z - 2z^2 - 1.4z^3      0.7z - z^2
#> [2,]  -1.5z + 0.9z^2 + 1.5z^3 - 0.9z^4  -1.5z - 0.6z^2 + 0.9z^3  -1.4z + 0.3z^2
#> [3,]   0.5z - 1.3z^2 - 0.5z^3 + 1.3z^4   0.5z - 0.8z^2 - 1.3z^3  -0.8z - 0.7z^2 
