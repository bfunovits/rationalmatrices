...
#>       s[1]  s[2]  s[3]  u[1]  u[2]
#> s[1] -0.80 -0.45 -1.16 -0.46 -0.34
#> s[2]  0.52 -0.89 -0.41 -0.60  0.63
#> s[3]  0.45  0.10  0.40 -0.16 -0.12
#> x[1]  0.73  0.43  0.57  1.00  0.00
#> x[2]  0.80 -1.65  1.00  0.00  1.00
min(abs(poles(x))) > 1
#> [1] TRUE
min(abs(zeroes(x))) > 1
#> [1] TRUE
...
#> s[1]  0.00  0.00  1.00 0.00  0.00  0.10 -0.67
#> s[2]  0.00  0.00  0.00 1.00  0.00  0.79 -0.09
#> s[3] -0.60  0.64 -0.27 0.08  0.00 -0.15  0.68
#> s[4]  0.00  0.00  0.00 0.00  1.00 -0.69  0.31
#> s[5] -0.08  0.49 -0.10 0.14 -0.46 -0.66  0.17
#> x[1]  1.00  0.00  0.00 0.00  0.00  1.00  0.00
#> x[2]  0.00  1.00  0.00 0.00  0.00  0.33  1.00
#> x[3]  0.00 -0.24  0.00 0.00  0.00  0.06  0.45
min(abs(poles(x))) > 1
#> [1] TRUE
