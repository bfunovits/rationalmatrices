...
#>       s[1]  s[2]  s[3] u[1]  u[2]
#> s[1]  0.32 -0.06  0.10 0.02  0.04
#> s[2] -0.40 -0.05 -0.14 0.13 -0.43
#> s[3]  0.75 -0.35 -0.33 0.15  0.25
#> x[1] -0.17  0.45 -0.11 1.00  0.00
#> x[2] -0.06  0.15  0.25 0.00  1.00
min(abs(poles(x))) > 1
#> [1] TRUE
min(abs(zeroes(x))) > 1
#> [1] TRUE
...
#> s[1]  0.00  0.00  1.00  0.0  0.00  0.35  0.62
#> s[2]  0.00  0.00  0.00  1.0  0.00  0.05 -0.31
#> s[3]  0.17 -0.19 -0.77 -0.2  0.00 -0.15 -0.08
#> s[4]  0.00  0.00  0.00  0.0  1.00 -0.26 -0.95
#> s[5]  0.30  0.11 -0.46 -0.5 -1.55 -0.88  1.33
#> x[1]  1.00  0.00  0.00  0.0  0.00  1.00  0.00
#> x[2]  0.00  1.00  0.00  0.0  0.00  0.77  1.00
#> x[3] -0.05  0.87  0.00  0.0  0.00 -0.07 -0.57
min(abs(poles(x))) > 1
#> [1] TRUE
