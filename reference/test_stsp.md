...
#>       s[1]  s[2]  s[3]  u[1]  u[2]
#> s[1]  1.02 -1.06  0.17 -1.14 -0.08
#> s[2]  0.29  0.56  0.48  0.16 -0.21
#> s[3] -0.17 -0.69 -0.05 -0.38 -0.24
#> x[1]  0.06  0.67  0.78  1.00  0.00
#> x[2] -0.65  0.04 -0.28  0.00  1.00
min(abs(poles(x))) > 1
#> [1] TRUE
min(abs(zeroes(x))) > 1
#> [1] TRUE
...
#> s[1]  0.00  0.00  1.00 0.00  0.00  0.21 -0.06
#> s[2]  0.00  0.00  0.00 1.00  0.00 -0.19 -0.66
#> s[3] -0.24 -1.30 -0.11 0.19  0.00  0.25  0.51
#> s[4]  0.00  0.00  0.00 0.00  1.00  0.16  0.68
#> s[5]  0.46  0.58  0.37 0.53 -0.76  0.80  0.32
#> x[1]  1.00  0.00  0.00 0.00  0.00  1.00  0.00
#> x[2]  0.00  1.00  0.00 0.00  0.00  0.89  1.00
#> x[3] -1.14  0.68  0.00 0.00  0.00 -0.23 -0.46
min(abs(poles(x))) > 1
#> [1] TRUE
