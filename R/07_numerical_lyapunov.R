...
#
# Purpose: Provide R interface to Lyapunov equation solver
#   - lyapunov_solver(): Solve P = APA' + Q via Schur decomposition
#   - Stability verification
#   - R wrapper for C++/RcppArmadillo implementation
#
# Related Files: src/lyapunov.cpp, inst/include/rationalmatrices_lyapunov.h
# ===================================================================

# 07_numerical_lyapunov.R
#
