...
#
# Purpose: Implement transpose operations for rational matrices
#   - t(): Standard transpose
#   - Ht(): Hermitian (conjugate) transpose
#   - Applies to all rational matrix representations
#
# Related Files: 03_arithmetic_operations.R (other operations)
# ===================================================================
