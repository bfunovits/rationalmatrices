...
#
# Purpose: Compute derivatives of rational functions/matrices
#   - derivative(): Compute dh/dz for rational matrices
#   - Supports all representation types
#   - Used for stability and spectral analysis
#
# Related Files: 05_analysis_poles_zeroes.R (spectral analysis)
# ===================================================================

# 05_analysis_derivative.R #######################################
