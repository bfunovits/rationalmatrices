...
#
# Purpose: Implement validation/type-checking methods
#   - is.polm(), is.lpolm(), is.lmfd(), is.rmfd(), is.stsp()
#   - is.pseries(), is.zvalues(), is.ratm()
#   - Check object types and properties
#
# Related Files: 01_representation_classes.R (class definitions)
# ===================================================================
