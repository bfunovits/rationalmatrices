...
#
# Purpose: Create rational matrices in different forms
#   - polm(): Polynomial matrices
#   - lpolm(): Laurent polynomial matrices
#   - lmfd(), rmfd(): Matrix fraction descriptions
#   - stsp(): State-space representations
#   - pseries(), zvalues(): Series and frequency response values
#
# Related Files: 01_representation_conversions.R (conversions), 03_arithmetic_operations.R (operations)
# ===================================================================
