...
#
# Purpose: Implement dimension-related methods
#   - dim(): Get dimensions of rational matrices
#   - nrow(), ncol(): Get number of rows/columns
#   - length(): Get total size
#
# Related Files: 10_utilities_extract.R (subsetting)
# ===================================================================
