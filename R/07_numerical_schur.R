...
#
# Purpose: Schur decomposition and related analysis
#   - Schur decomposition algorithm (via QZ package)
#   - Tools for eigenvalue and stability analysis
#   - Supporting infrastructure for Lyapunov solver
#
# Related Files: 07_numerical_lyapunov.R (Lyapunov solver), 06_statespace_methods.R (state-space)
# ===================================================================

# 07_numerical_schur.R
#
