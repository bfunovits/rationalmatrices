# ===================================================================
# Functional Area #5: Analysis & Properties (CLAUDE.md)
#
# Purpose: Compute and analyze poles and zeros
#   - poles(): Compute roots of characteristic polynomial (via eigendecomposition)
#   - zeroes(): Compute transmission zeros
#   - Stability analysis: Check if all poles inside unit circle
#   - Spectral properties analysis
#
# Related Files: 06_statespace_methods.R (state-space realization), 08_reflection_poles_zeroes.R (pole/zero operations)
# ===================================================================
