...
#
# Purpose: Create and manage power series representations
#   - pseries(): Create impulse response power series h₀ + h₁z⁻¹ + h₂z⁻² + ...
#   - Power series coefficients for system analysis
#
# Related Files: 01_representation_classes.R (constructors), 01_representation_conversions.R (conversions to/from pseries)
# ===================================================================
